...
<body
    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; background-color: #ffffff; color: #141414; height: 100%; line-height: 1.4; margin: 0; padding: 0; width: 100% !important;">
    <style>
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="http://127.0.0.1:8000"
                                ...
                                <img src="https://shopbeta.game-lot.com/frontend/assets/images/ESCUDO.png" class="logo" alt="Game-Lot Logo"
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 200px;">
                            </a>
                        </td>
                    </tr>
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 16px; font-weight: bold; margin-top: 0; text-align: left;">
                                            Informacion del Cliente</h1>

                                        <table width="100%" style="background: #F7F7F7; padding:0 5 0 5px;"
                                            class="font">
                                            <tr>
                                                <td>
                                                    <p class="font" style="margin-left: 16px;">
                                                        <strong>Nombre:</strong> {{$order['order']->name}} <br>
                                                        <strong>Correo:</strong> {{$order['order']->email}} <br>
                                                        <strong>Telefono:</strong> {{$order['order']->phone}} <br>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 12px; line-height: 1.5em; margin-top: 0; text-align: justify;">
                                            Tu orden estará pendiente hasta que podamos confirmar tu pago y los
                                            productos se te reservaran con un máximo de 2 horas siguientes a tu orden.
                                            para confirmar tu pago des seguir estos pasos:<br>
                                            1. Debes responder este correo con un captura de pantalla del depósito o la
                                            transferencia.<br>
                                            2. Enviarnos la misma captura de pantalla a nuestro whatsapp 314 784 9806 de
                                            esta manera nuestro equipo podrá validar tu pago en nuestro sistema y
                                            procesar tu orden para ser enviada, podrás consultar el estado tu orden en
                                            tu perfil de nuestra tienda ingresando a tu orden.
                                        </p>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © 2022 Game-Lot. todos los derechos reservados.</p>
