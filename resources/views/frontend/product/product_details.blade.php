					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
                            ...
                            <div class="description-container m-t-20">
                                @if(session()->get('language') == 'spanish') {{$product->short_descp_esp}} @else {{$product->short_descp_en}} @endif
							...
							<div class="price-container info-container m-t-20">
								...
								{{-- Start Product Color and Product Size --}}
								<div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
							...
							<div class="tab-content">
                                ...
                                <div id="description" class="tab-pane in active">
                                    <div class="product-tab">
                                        <p class="text">
                                            @if(session()->get('language') == 'spanish') {!!$product->long_descp_esp!!} @else {!!$product->long_descp_en!!} @endif
                                    </div>
								</div><!-- /.tab-pane -->
