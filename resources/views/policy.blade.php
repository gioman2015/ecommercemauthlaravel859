                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="http://127.0.0.1:8000"
                                ...
                                <img src="{{asset('frontend/assets/images/MADERA.png')}}" class="logo" alt="Game-Lot Logo"
                                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 150px;">
                            </a>
                        </td>
                    </tr>
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <h1
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #000000; font-size: 26px; font-weight: bold; margin-top: 0; text-align: left;">
                                        ...
                                        <p
                                            ...
                                            Edite este archivo para definir la política de privacidad de su aplicación.</p>
