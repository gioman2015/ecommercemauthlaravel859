      ...
      <section class="content">
        <div class="row">
          ...
          <div class="col-8">
           ...
           <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Lista de SubCategorías<span class="badge badge-pill badge-danger"> {{ count($subcategories) }} </span></h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
          ...
          <div class="col-4">
            ...
            <div class="box">
               <div class="box-header with-border">
                 <h3 class="box-title">Agregar SubCategoría</h3>
               </div>
               <!-- /.box-header -->
               <div class="box-body">
                   <div class="table-responsive">
                      ...
                      <div class="form-group">
                        ...
                        <div class="controls">
                            <select name="category_id" id="select" required="" class="form-control">
                                <option value="" selected="" disable="">Seleccionar Categoría</option>
