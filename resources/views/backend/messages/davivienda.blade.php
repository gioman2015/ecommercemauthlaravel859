      ...
      <section class="content">
        <div class="row">    
          ...
          <div class="col-12">
           ...
           <div class="box">
              <div class="box-header with-border">
                <h3 class="box-title">Informacion Davivienda</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                            <tr>
                                <td>{{$davivienda->tipo}}</td>
                                <td>{{$davivienda->numero}}</td>
                                <td>{{$davivienda->cc}}</td>
                                <td>{{$davivienda->titular}}</td>
                            </tr> 
                      </tbody>
                    </table>
                  </div>
          ...
          <div class="col-12">
            ...
            <div class="box">
               <div class="box-header with-border">
                 <h3 class="box-title">Actualizar Informacion Davivienda</h3>
               </div>
               <!-- /.box-header -->
               <div class="box-body">
                   <div class="table-responsive">
                    <form method="POST" action="{{route('davivienda.update')}}">
                      @csrf
